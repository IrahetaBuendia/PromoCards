...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    if (result.error || !result.url) {
      setGoogleError(result.error ?? "Error desconocido");
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
